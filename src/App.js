...
import Vetri from "./images/RahulAvatar.jpg";
import {
  VerticalTimeline,
      ...
      <div className="flex w-screen min-h-screen flex-col items-center justify-center relative bg-primary pb-20">
        <nav className="w-full px-6 z-50  fixed inset-x-0 top-2 flex justify-center items-center ">
          <div className=" w-full md:w-880 bg-navBar p-4 rounded-2xl flex items-center">
            <p className="text-lg text-slate-200 font-medium">Rahul</p>
        ...
        <main className="w-[80%] mt-4">
          ...
          >
            ...
            <div className="w-full h-420 flex flex-col items-center justify-center mt-5">
              <p className="text-lg text-textBase text-center flex flex-col items-start justify-start ">
              Hi, Rahul this side and I am a Full Stack Developer with a passion for creating innovative designing and developing websites and platforms using the latest technologies.
              I have a strong background in library such as ReactJs, TailwindCss (open-source, utility-first CSS framework ) and Firebase (backend-as-a-service platform) and have honed my skills in HTML,CSS,JavaScript.
              I am dedicated to staying up-to-date with the latest advancements in technology and always striving to improve my skills.
              Apart from Full Stack Developer I have a strong background in programming languages such as Java and MySQL and have honed my skills in Data Structures and Algorithms.
              </p>
